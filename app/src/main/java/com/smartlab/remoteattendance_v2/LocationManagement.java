...
public class LocationManagement extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AssignTo.setText(uid.replaceAll("'",""));
        PhoneID.setText(substrDeviceID.replaceAll("'",""));
    ...
    public String verifyLocationCreator(String locationKey, String LocationName) {
        ...
        try {
            ...
            if (android.os.Build.VERSION.SDK_INT > 9) {
                ...
                Log.i("JWT request Loc Raw Data : ", uid + "||" + pwd + "||" + deviceID + "||" + LocationName + "_" + uid + "||" + locationKey + "||Android");
                Log.i("JWT request Loc Enc Data : ", encData);
                JSONObject jsonParam = new JSONObject();

                jsonParam.put("JWT", encData.replaceAll("\\n",""));
    ...
    public String encryption(String strNormalText) {
        ...
        try {
            ...
            e.printStackTrace();
            Log.e("Workplace token encrypt", e.getMessage());
        }
    ...
    public String Decryption(String strNormalText) {
        ...
        try {
            ...
            // TODO Auto-generated catch block
            e.printStackTrace();
            Log.e("Workplace token Error Dec", e.getMessage());
        }
        return normalTextEnc;
    }
    ...
    public void addListenerOnButton() {
        ...
        Button btnRegister = (Button) findViewById(R.id.btnLocManRegister);
        Button btnReset = (Button) findViewById(R.id.btnLocManReSET);
        Button btnCancel = (Button) findViewById(R.id.btnLocManCancel);

        EditText LocKey = (EditText) findViewById(R.id.edtxtLocKey);
        EditText LocName = (EditText) findViewById(R.id.edtxtPhoneName);
        ...
        btnRegister.setOnClickListener(new View.OnClickListener() {
            public void onClick(View arg0) {
                ...
                if(token.isEmpty() != true || token.length() != 0){
                    ...
                    AlertDialog alertDialog = new AlertDialog.Builder(LocationManagement.this).create();
    ...
    public static String getIMEIDeviceIdtest(Context context) {
