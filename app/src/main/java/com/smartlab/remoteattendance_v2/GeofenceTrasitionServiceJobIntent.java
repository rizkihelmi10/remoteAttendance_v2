...
public class GeofenceTrasitionServiceJobIntent extends JobIntentService {
    ...
    public GeofenceTrasitionServiceJobIntent() {
    }
    ...
    protected void onHandleWork(@NonNull Intent intent) {
        ...
        if (intent != null) {
            Log.d(TAG, "tak kosong");
            Log.d("bendera",String.valueOf(geoFenceTransition));
