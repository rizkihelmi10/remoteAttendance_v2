...
public class dbActivities {
    ...
    public boolean SaveDB(MySQLiteHelper helper, int primary, String Title, String Info, String NType, byte[] Image1, String SynCA, String sDomain, String sImgLoc)
    {   	
    	
    	/*
    	 public boolean SaveDB(MySQLiteHelper helper, int primary, String Author, String AuthorMail, 
    	...
    	//values.put(MySQLiteHelper.NewsID, null);
    	//values.put(MySQLiteHelper.Author, Author);
    	//values.put(MySQLiteHelper.AuthorMail, AuthorMail);
    	values.put(MySQLiteHelper.Title, Title);
    	values.put(MySQLiteHelper.Info, Info);
    	values.put(MySQLiteHelper.NType, NType);
    	values.put(MySQLiteHelper.Pic, Image1);
    	//values.put(MySQLiteHelper.SynCB, SynCB);
    	values.put(MySQLiteHelper.SynCA, SynCA);
    	values.put(MySQLiteHelper.Domain, sDomain);
    	values.put(MySQLiteHelper.imgLoc, sImgLoc);
    	    	
    	try {
	    	db.insertOrThrow(MySQLiteHelper.TABLE, null, values); 
    ...
    public boolean updateDB(String Pid, int primary)
	 {
		 ...
		 ContentValues values = new ContentValues();
	    	...
	    	// Insert into database
	    	values.clear(); 
	    	values.put(MySQLiteHelper.NewsID, Pid);
